<div class="btn-group btn-group-xs">
    {{--<a href="{{ route("$resourcePrefix.show", [$object->pk]) }}" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> {{ __('View') }}</a>--}}
    <a href="{{ route("$resourcePrefix.edit", [$object->pk]) }}" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> {{ __('Edit') }}</a>
    <?php
